...
import jane.kaggle_evaluation.core.base_gateway
import jane.kaggle_evaluation.core.relay

_initial_import_time = time.time()
_issued_startup_time_warning = False


class Gateway(jane.kaggle_evaluation.core.base_gateway.BaseGateway, abc.ABC):
    '''
    ...
    def run(self):
        ...
        try:
        ...
        except jane.kaggle_evaluation.core.base_gateway.GatewayRuntimeError as gre:
            error = gre
        except Exception:
            ...
            error = jane.kaggle_evaluation.core.base_gateway.GatewayRuntimeError(
                jane.kaggle_evaluation.core.base_gateway.GatewayRuntimeErrorType.GATEWAY_RAISED_EXCEPTION,
                error_str
            )
        ...
        if jane.kaggle_evaluation.core.base_gateway.IS_RERUN:
...
class InferenceServer(abc.ABC):
    ...
    def __init__(self, endpoint_listeners: Tuple[Callable]):
        self.server = jane.kaggle_evaluation.core.relay.define_server(endpoint_listeners)
        ...
        self._startup_limit_seconds = jane.kaggle_evaluation.core.relay.STARTUP_LIMIT_SECONDS
